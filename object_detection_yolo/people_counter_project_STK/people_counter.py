...
cap = cv2.VideoCapture("/home/eldar/PycharmProjects/object_detection_yolo/videos/BITCENTAR/BIT_CENTAR/A09_20240313111031.mp4")
...
while True :
    ...
    #cv2.imshow("ImageRegion", imgRegion) # video sa maskom
